...
def learnD_Realness(param, D, G1, G2, optimizerD, random_sample, Triplet_Loss, x, anchor1, anchor0):
    ...
    for t in range(param.D_updates):
        ...
        for _ in range(param.effective_batch_size // param.batch_size):
            ...
            loss1 = Triplet_Loss(feat_fake1, feat_fake2)
            #loss1.backward()
    ...
    return lossD, lossD_real, lossD_fake1, lossD_fake2, loss1
